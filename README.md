...
৬. **SDK সেটআপ (Step 3):** এখানে **Kotlin** সিলেক্ট করুন। কনসোলে যে কোডগুলো দেখাবে সেগুলো কপি করার প্রয়োজন নেই, কারণ Capacitor এগুলো অটোমেটিক হ্যান্ডেল করে। আপনি শুধু "Next" দিয়ে সেটআপ শেষ করুন।
৭. আপনার প্রজেক্টের **`android/app/`** ফোল্ডারের ভেতরে ডাউনলোড করা ফাইলটি রাখুন এবং গিটহাবে পুশ করুন।
