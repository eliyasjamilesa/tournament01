...
৬. আপনার প্রজেক্টের **একদম প্রধান ফোল্ডারে (Root Directory)** ডাউনলোড করা ফাইলটি রাখুন এবং গিটহাবে পুশ করুন।

> **নোট:** ফাইলটি না থাকলে GitHub থেকে ডাউনলোড করা APK-তে নোটিফিকেশন কাজ করবে না এবং অ্যাপ ক্র্যাশ করার সম্ভাবনা থাকতে পারে।
